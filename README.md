...
## Project Structure
    ...
    ├── developer_churn_handlin_2  # Django project configurations
...
1. Clone this repo and `cd developer_churn_handlin_2`
...
2. Clone this repo and `cd developer_churn_handlin_2`
